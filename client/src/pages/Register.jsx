...
export default function Register() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-slate-50 dark:bg-gradient-to-br dark:from-slate-900 dark:via-blue-900 dark:to-slate-900 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-blue-500/30 rounded-full blur-3xl animate-pulse hidden dark:block" />
            <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-purple-500/30 rounded-full blur-3xl animate-pulse delay-1000 hidden dark:block" />

            <div className="w-full max-w-md p-8 bg-white dark:bg-white/10 dark:backdrop-blur-xl border border-slate-200 dark:border-white/20 rounded-2xl shadow-xl dark:shadow-2xl relative z-10 mx-4 my-8 transition-all duration-300">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-100 dark:bg-gradient-to-tr dark:from-blue-500 dark:to-purple-600 mb-4 shadow-sm dark:shadow-lg">
                        <UserPlus className="w-8 h-8 text-blue-600 dark:text-white" />
                    </div>
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Create Account</h2>
                    <p className="text-slate-500 dark:text-blue-200 text-sm">Join us to manage your finance smartly</p>
                </div>
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-slate-700 dark:text-blue-100 mb-1 ml-1">Full Name</label>
                            <input
                                type="text"
                                required
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-700 dark:text-blue-100 mb-1 ml-1">Email address</label>
                            <input
                                type="email"
                                required
                                className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-600 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
